...
public class BuildNumber {
     ...
     */
    public BuildNumber(String revision, String branch, String tag, String parent, int commitsCount, String commitDate, String buildDate) {
	...
	/**
	 * @return the buildDate timestamp
	 */
