...
public class BuildNumberTest {
	...
	buildNumber = new BuildNumber("1234567890", "branch", "tag", "parent", 37, "2019-01-01", "2019-02-20", "1.2.10-15-g4942ddb", "2019-02-21 14:05:30");
    }
	...
	BuildNumber buildNumber = new BuildNumber("1234567890", "branch", "", "parent", 37, "2019-01-01", "2019-02-20", "1.2.10-15-g4942ddb", "2019-02-21 14:05:30");
	...
	BuildNumber buildNumber = new BuildNumber("1234567890", "", "", "parent", 37, "2019-01-01", "2019-02-20", "1.2.10-15-g4942ddb", "2019-02-21 14:05:30");
